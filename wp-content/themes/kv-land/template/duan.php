...
if (!empty($_GET['keywords'])) {
    $search_type_project = sanitize_text_field($_GET['keywords']);
...
if (!empty($_GET['status_project'])) {
    $search_prices = sanitize_text_field($_GET['status_project']);
    $arr_meta_query = array(
...
<section class="section-banner-da">
    <div class="image">
        <figure>
            <img src="<?= getimage(get_field('banner')) ?>" alt="">
        </figure>
    </div>
    <div class="content">
        <div class="breckcum">
...
<?php if (!empty($highlight_pro['list'])):
    $pri_post = $highlight_pro['list'][0]['post'];
    ...
    $arr_s = get_the_terms($pri_post->ID, 'type_project');
    ?>
        ...
        <div class="content">
            ...
            <div class="col-right">
                <div class="text">
                    <div class="info">
                        <div class="status">
                            <span><?= $status_project ?></span>
                        </div>
                        <div class="name">
                            <h3><?= $arr_s[0]->name ?> <span><?= get_the_title($pri_post->ID) ?></span></h3>
                        </div>
                        <div class="desc">
...
<?php endif; ?>
<?php if (!empty($highlight_pro['list']) && count($highlight_pro['list']) > 1): ?>
    <section class="section-da-2">
        <div class="container">
            <div class="title">
                ...
                <h2><?= $highlight_pro['title'] ?></h2>
            </div>
            <div class="content row">
                <?php foreach ($highlight_pro['list'] as $key => $value):
                    if ($key > 0):

                        $status_project = get_the_terms($value['post']->ID, 'status_project')[0]->name;
                        $arr_s = get_the_terms($value['post']->ID, 'type_project');
                        ...
                        <div class="col-xl-6">
                            <div class="child">
                                <div class="image">
                                    <figure>
                                        <a href="<?= get_permalink($value['post']->ID) ?>">
                                        <img src="<?= getimage($value['post']->ID, 'large', 'post') ?>" alt="">
                                        </a>
                                    </figure>
                                    <div class="info">
                                        <p class="status">
...
<!--                                                      fill="white"/>-->
<!--                                            </svg>-->
<!--                                            Diện tích: --><?//= get_field('area', $value['post']->ID) ?>
<!--                                        </p>-->
                                    </div>
                                </div>
                                <div class="text">
                                    <div class="category">
                                        <span><?= $arr_s[0]->name ?></span>
                                    </div>
                                    <h3><span></h3>
                                    <div class="name">
                                        <a href="<?= get_permalink($value['post']->ID) ?>"><?= get_the_title($value['post']->ID) ?></span></a>
                                    </div>
                                    <div class="desc">
                                        <p><strong>Vị trí:</strong>
                                            <span><?= get_field('address', $value['post']->ID) ?></span></p>
<!--                                        <p><strong>Diện tích:</strong>-->
<!--                                            <span>--><?//= get_field('area', $value['post']->ID) ?><!--</span></p>-->
                                        <p><strong>Chủ đầu tư:</strong>
                                            <span><?= get_field('company', $value['post']->ID) ?></span></p>
                                    </div>
                                    <div class="action">
                                        <div class="left">
                                            <a href="<?= get_permalink($value['post']->ID) ?>" class="advise">Tư vấn cho
                                                tôi</a>
                ...
                <div class="col-left">
                    <div class="title">
                        ...
                        <div class="right">
                            <div class="child">
                                <p>Số dự án:</p>
                                <span class="count_number"> <?= $post_all->found_posts ?> dự án</span>
                            </div>
                            <div class="child">
                                <p>Trạng thái:</p>
                    ...
                    <div class="list row lisst_post">
                        <?php if ($post_all->have_posts()): ?>
                            <?php while ($post_all->have_posts()) :
                                $post_all->the_post();
                                $status_project = get_the_terms(get_the_ID(), 'status_project')[0]->name;
                                $arr_s = get_the_terms(get_the_ID(), 'type_project');
                                ?>
                                <div class="col-6">
                                    <div class="child">
                                        <div class="top">
...
<!--                                                    <span>--><?//= get_field('area') ?><!--</span></p>-->
                                        ...
                                        <div class="action">
                                            <div class="left">
                                                <a href="javascript:;" class="advise  btn-tv ">Tư vấn cho tôi</a>
                    ...
                    <div class="fillter">
                        <div class="child">
                            ...
                            <div class="list">
                                <div class="item">
                                    <div class="left">
                                        <input type="radio" name="type_project" id="type_project"
                                               value="" <?= !empty($search_type_project) ? '' : 'checked' ?>>
                                ...
                                <?php foreach ($type_pro as $key => $value):
                                    ...
                                    <div class="item">
                                        <div class="left">
                                            <input type="radio"
                                                   value="<?= $value->term_id ?>" <?= $search_type_project == $value->term_id ? 'checked' : '' ?>
                                                   name="type_project" id="type_project_<?= $value->term_id ?>">
                        ...
                        <div class="child">
                            ...
                            <div class="list">
                                <div class="item">
                                    <div class="left">
                                        <input type="radio" name="areas" id="areas"
                                               value="" <?= !empty($search_areas) ? '' : 'checked' ?>>
                                        <label for="areas">
                                            Tất cả
                                        </label>
                                    </div>
                                ...
                                <?php foreach ($areas as $key => $value):
                                    ...
                                    <div class="item">
                                        <div class="left">
                                            <input type="radio"
                                                   value="<?= $value->term_id ?>" <?= $search_areas == $value->term_id ? 'checked' : '' ?>
                                                   name="areas" id="areas_<?= $value->term_id ?>">
                        ...
                        <div class="child">
                            ...
                            <div class="list">
                                <div class="item">
                                    <div class="left">
                                        <input type="radio" name="prices" id="prices"
                                               value="" <?= !empty($search_prices) ? '' : 'checked' ?>>
                                        <label for="prices">
                                            Tất cả
                                        </label>
                                    </div>
                                ...
                                <?php foreach ($prices as $key => $value):
                                    ...
                                    <div class="item">
                                        <div class="left">
                                            <input type="radio"
                                                   value="<?= $value->term_id ?>" <?= $search_prices == $value->term_id ? 'checked' : '' ?>
                                                   name="prices" id="prices_<?= $value->term_id ?>">
...
<script>
    $(document).ready(function () {
        ...
        var keyword = '<?=  !empty(sanitize_text_field($_GET['keywords'])) ? sanitize_text_field($_GET['keywords']) : '' ?>';
