                    ...
                    <div class="image">
                        <figure class="k">
                            <svg xmlns="http://www.w3.org/2000/svg" width="335" height="329" viewBox="0 0 335 329" fill="none">
                                <path d="M335 337.048L96.1897 98.2377V0H0V337.048H96.1897V234.682L199.899 338.392L335 337.048Z" fill="#B8B8B8"/>
                            </svg>
                        </figure>
                        <figure class="v">
                            <svg xmlns="http://www.w3.org/2000/svg" width="327" height="234" viewBox="0 0 327 234" fill="none">
                                <path d="M0 138.494L95.1657 233.692L326.936 0.0976562H192.187L94.8778 95.5514L0 3.74557V138.494Z" fill="white"/>
                            </svg>
                        </figure>
                    </div>
                </div>
