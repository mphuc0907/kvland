...
$highlight_pro = get_field('highlight_post',$term_now);
...
<section class="section-banner-da">
    <div class="image">
        <figure>
            <img src="<?= getimage(get_field('status_banner',$term_now)) ?>" alt="">
        </figure>
    </div>
    <div class="content">
        <div class="breckcum">
                    ...
                    <div class="fillter">
                        <div class="child">
                            ...
                            <div class="list">
                                <div class="item">
                                    <div class="left">
                                        <input type="radio" name="type_project" id="type_project_0"
                                               value="" <?= !empty($search_type_project) ? '' : 'checked' ?>>
                                        <label for="type_project_0">
                                            Tất cả
                                        </label>
                                    </div>
